package com.liufu.game2048publish;
...
public class GameView extends LinearLayout {
	...
	private void checkComplete(){
		...
		if (complete) {
			new AlertDialog.Builder(getContext()).setTitle("你好").setMessage("游戏结束").setPositiveButton("重新�?�?", new DialogInterface.OnClickListener() {
